          ...
          <div className="flex items-center">
            ...
            {!currentAccount && (
              <ul className="flex items-center hidden space-x-8 lg:flex">
                ...
                <button onClick={() => connectWallet()} className="text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 mr-2 mb-2"
                  aria-label='sign up'
                title='sign up'>
  ...
  Connect with MetaMask
            ...
            <div className="lg:hidden z-40">
              <button
                ...
                title='Open Menu'
                className="p-2 -mr-1 transition duration-200 round focus:outline-none focus:shadow-outline"
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div>
                        <a
                          ...
                          <span className="ml-2 text-xl font-bold tracking-wide text-grey-800 uppercase">
                            Company
                          </span>
                        </a>
                      </div>
                            ...
                            return (
                                <li key={i + 1}>
                                  <a
                                    ...
                                    aria-label='our product'
                                    title='our product'
                                    className="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400"> {el}
                                  </a>
                                </li>
                            );
                        })}
